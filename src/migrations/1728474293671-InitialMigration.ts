...
export class InitialMigration1728474293671 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    // Alter tables to set foreign key relationships and update constraints
    ...
    // Updating reservation table foreign key constraints
    await queryRunner.query(
    ...
    // Updating trip table foreign key constraints
    await queryRunner.query(
    ...
    // Updating car table foreign key constraints
    await queryRunner.query(
    ...
    // Updating license table foreign key constraints
    await queryRunner.query(
    ...
    // Updating notification table foreign key constraints
    await queryRunner.query(
